...
![](assets/c13e6a34-1bd6-4951-9b96-af43c0141805.png)
...
![](assets/d4e932bb-6e6d-44d7-b6bc-35c329621758.png)
...
![](assets/74a466cf-1ec0-4162-a067-7dd539208bb7.png)
...
![](assets/6d49b1df-b197-402b-a99a-81ec040e03d3.png)
...
![](assets/9a415585-69d2-4723-8168-6976d609203e.png)
...
![](assets/0bfe226a-3473-4b77-86ce-53f3d982cfbf.png)

这意味着我们现在可以将我们的特征的线性组合(好的，我们只有一个和一个常数，但这将很快改变)拟合到对数(赔率)值。从某种意义上说，我们用![](assets/0f620c9d-a063-4b0f-a574-4a462fb874a2.png)代替了[第一章](01.html)、*Python 机器学习入门*、![](assets/cb2700d0-ce9a-4956-84f9-f53d5417abfd.png)(用 log(赔率)代替 y)。

我们可以为![](assets/d07617f8-3597-4d51-8061-bcec8adacb1f.png)解决这个，这样我们就有了![](assets/f1da5f45-4177-4796-ac08-44668e034028.png)。
...
![](assets/10848ce2-a224-4318-bb39-0725443aa349.png)
...
![](assets/16b90eb9-460a-48a3-b40f-e24e0bc7ef99.png)
...
![](assets/cf3dd599-ee35-42b8-86c3-7d4adec96770.png)
...
![](assets/06be1c10-2aeb-4759-bcd3-8cb233c90dd8.png)

相反，如果我们的目标是发现尽可能多的好或坏的答案，我们会对回忆更感兴趣:

![](assets/d259a3ff-e75b-4f90-8a53-d95e7c840b1e.png)

参考下图:

![](assets/75a86179-2774-4589-9070-0cfa96b9073e.png)
...
![](assets/74ed4c95-c549-4891-95c8-332e96b0403a.png)
...
![](assets/5777d5ee-d127-4658-ba91-95e44dce0d2b.png)
...
![](assets/95db748f-18ec-4caf-8a0a-a41486b82e3e.png)
