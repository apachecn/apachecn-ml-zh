...
![](assets/165e5351-6d27-4a0d-be73-bf40c3d8df31.png)
...
![](assets/6776042f-6aa6-4679-ad10-88e5a63433bd.png)
...
![](assets/20693fb2-5b9c-4697-9ef8-71e1169f77c9.png)
...
![](assets/948fc509-81ad-4ec3-9012-8d8867d41ab3.png)
...
![](assets/db15a1eb-e8cb-40c2-bbcc-222fe193e9bf.png)
...
![](assets/a7e8b29a-189f-44d6-b5b1-1f03e08ebd2d.png)
...
![](assets/31cf72fa-f8a9-4bd4-9a61-f9193e1096c3.png)
...
![](assets/251ae7ce-ea13-446d-a7ea-8c372fbc9cf0.png)
...
![](assets/02e9a6e4-5321-44f8-b545-b0e6cd0bf18f.png)
...
![](assets/56a960f6-4a96-4e97-883e-17277d02904c.png)
...
![](assets/79466b97-a3cf-45e3-9f64-df1346e7efb2.png)

一旦完成所有作业，新质心将作为算术平均值重新计算:

![](assets/2654403d-f595-446f-a602-b22518cc792f.png)
...
![](assets/7a396ec7-a6d1-4776-8bfb-cb03028f76a7.png)

*D()*代表样品 *x ∈ X* 和已经选择的质心之间的最短距离。一旦计算出函数，就可以确定概率分布 *G(x)* ，如下所示:

![](assets/c5c5330a-28ea-4610-b18e-e25a45a3d399.png)
...
![](assets/3ad9f4df-5b14-4473-8e60-6c6a94113d0d.png)

由于 *S* 减少了一个更好的选择，前面的公式为期望值*E【S】*设定了一个上限，大致与 *log K* 成正比。例如对于 *K=10* 、*E【S】![](assets/2a4a8dc7-9511-42b7-9190-213e1d376b85.png)19.88![](assets/8e1db6f7-d663-4345-a87e-7f79fab73475.png)S<sub class="calibre20">opt</sub>*和*E【S】![](assets/2a4a8dc7-9511-42b7-9190-213e1d376b85.png)12.87![](assets/8e1db6f7-d663-4345-a87e-7f79fab73475.png)S<sub class="calibre20">opt</sub>*对于 *K=3* 。这一结果揭示了两个重要因素。第一个是 *K* 不是特别大的时候 K-means++表现更好，第二个，可能也是最重要的一个，是单个 K-means++初始化不能足以获得最优配置。因此，常见的实现(例如 scikit-learn)会执行可变数量的初始化，并选择初始惯性最小的一个。
...
![](assets/d74fa1bc-0ff5-4cf0-b446-501b8ecb7340.png)
...
![](assets/547f2d24-2fa1-442a-9fae-48d8f2101df3.png)
...
![](assets/76f8af1e-fb26-4c7c-b513-3c22f2e7a99b.png)
...
![](assets/95b0ef98-33df-43c6-9048-2646a247fc7e.png)
...
![](assets/322cf165-b1a9-4232-af3b-dd6df21c53a4.png)
...
![](assets/ff8ae401-b30f-43e8-bb3d-51a4b94b3531.png)
...
![](assets/aafbed3f-3a72-4178-9011-37c00df8ce23.png)
...
![](assets/66165fe7-cca1-420c-b2c8-71ffbfe2d2d8.png)
...
![](assets/18fc95e3-1810-4f73-b667-60fd6b38760c.png)
...
![](assets/587be3b8-98fa-4865-bda2-dc81fb1ffc50.png)
...
![](assets/6d06560c-6407-440e-b835-f40070b91824.png)
...
![](assets/f69d0af8-8bc1-4c93-96b4-966cb0576f90.png)

通过这两个度量，我们可以定义 *x <sub class="calibre20">i</sub> ∈ X* 的轮廓分数:

![](assets/711bbc3f-b474-41f6-a54f-93d5fe852a59.png)
...
![](assets/525f0950-ddf2-4279-9c1a-7000ce3a1a1f.png)
...
![](assets/f96440cf-9941-469f-8e59-c4db459c0097.png)
...
![](assets/bb659233-4d18-40b0-a974-eb645ad18ab2.png)
...
![](assets/a0058b86-18c3-459c-bf62-7fc1c35afc87.png)
...
![](assets/2842e1c8-983a-44b0-a84b-3e44faca51e7.png)
...
![](assets/208136bf-137d-46b0-a63c-99b1a72464e5.png)
...
![](assets/a621ff93-b1e0-4663-93fe-7dac3169b096.png)
...
![](assets/c7a9d2b5-b5bd-4071-9558-e0b615a77c60.png)
...
![](assets/d14f12e6-41ca-4082-a8db-74afaa1370a5.png)

显然，该值可以由 *a* 或 *b* 控制。在这两种情况下，较高的分数表明作业符合基本事实。然而， *a* 和 *b* 都有可能被随机分配所偏向。这就是为什么引入了调整后的兰德分数。更新后的公式为:

![](assets/08edb6be-5dee-4a22-81fd-3b6dc49ee1a3.png)
...
![](assets/a5efa5bc-14b5-44e3-beb0-10c360696630.png)
...
![](assets/7b152ca0-7fd8-4993-bbe9-26de5ca22350.png)

选择第一个球以捕获所有样本。此时，其他更小的球嵌套在*β<sub class="calibre20">R0</sub>T3】中，确保每个样品始终属于一个球。在下图中，有一个简单球树的示意图:*

![](assets/05e3457f-cea4-4480-9261-6cc1010f7823.png)
...
![](assets/de8295ff-3225-4772-b868-e85d1a98137c.png)
...
![](assets/6acb69db-60e8-4ca1-92fd-98f40f831451.png)
...
![](assets/4dea69de-b863-49e9-aecc-64441e7b9ccd.png)
...
![](assets/cfb86f7a-2dce-4c03-9d28-1886d7c91fea.png)
...
![](assets/c661aadf-8aae-416e-97bc-b331de4a0af8.png)
...
![](assets/e4083e41-2003-4fa7-b7f3-2f89d53ac1b8.png)
...
![](assets/3ca0903d-ae6a-4d50-876d-2b402aff5517.png)
...
![](assets/7f746df8-c3e8-4ee9-9cea-be5f76238cb2.png)
...
![](assets/d3128ff0-f632-4a71-bd39-655c31928ff5.png)
...
![](assets/b8a8810a-c3f7-45af-9bf5-c52d7da2abd8.png)
