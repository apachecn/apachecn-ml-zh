...
![](assets/85a481c5-78cf-4e85-85b2-f8a8faa6cc13.png)
...
![](assets/4db86673-2afb-402b-a4b5-024582b58949.png)
...
![](assets/ac69d18f-0a9d-4ea7-9837-d658e8d1b89c.png)

这种方法简单而且相当可靠，但是得到的图并不是完全连通的。这种情况可以通过使用如下定义的径向基函数来轻松实现:

![](assets/4f5ad428-6f15-48c6-9fdf-28243aa857ed.png)
...
![](assets/48336cf2-f566-4d38-bb63-ba3c12267595.png)
...
![](assets/64e77204-f962-41bb-b3d1-076147f11b63.png)
...
*   如果 *A ![](assets/055b1708-309e-409f-ab58-e4017eae690d.png) ℜ <sup class="calibre27"> N </sup>* 和*θ*是 *A* 的可数子集(即 *X* 是可数子集，因为样本数总是有限的)，则给定 *θ <sub class="calibre20"> i，向量*v∈ℜ<sup class="calibre27">n</sup>t14】被称为**指示向量**,用于*θ*if 例如，如果我们有两个向量 *a = (1，0)* 和 *b = (0，0)* (所以，*θ= { a，b}* )并且我们考虑 *A = {(1，n)其中 n∈1，10】}*，则向量 *v = (1，0)* 是一个指示向量，因为 *a ∈ A**</sub>*
...
![](assets/004e9580-699d-4995-b7ec-1ec7119c6e6e.png)
...
![](assets/12b75552-ecb4-4d0c-9600-18f9c56e6040.png)
...
![](assets/9a04b232-2baf-4182-93e4-2589ad0863d0.png)

因此，收敛后，每个样本由最近的质心表示。不幸的是，这种近似导致了不可能代表真实过程的分段函数。因此，最好使用基于相同底层内核的平滑 Parzen 窗口*K()*:

![](assets/6d8ae609-2ad9-48b4-ab6a-58226436d1a1.png)
...
![](assets/56b8adef-5b58-4051-9ead-7105566eef4f.png)
...
![](assets/191cd488-c515-4840-b56f-2138d7929be0.png)
...
![](assets/e081689d-97bc-4ef5-833e-17ddcc48e51d.png)
...
![](assets/9fddf7e1-0071-485e-bd33-c60a17b29d14.png)
...
![](assets/20cd8208-d768-4e45-b2b4-b5943b8908eb.png)
...
![](assets/01b82f74-374a-45b3-b789-3cb5d7d9e745.png)
 ...
 **![](assets/741ff380-397d-4cc0-b3e3-e2386ba5783e.png)
...
![](assets/35bb2ca3-fcae-4e7b-9943-107c6e61c69d.png)
...
![](assets/3c40be02-03d1-4795-a6e8-ecba3faac6cb.png)
...
![](assets/dbcdbb62-2632-4b58-b8ab-fcecec940d5d.png)
...
![](assets/2e0b2920-1c6a-414b-b922-8b19c762b6c6.png)
...
![](assets/bb182b6f-ada9-4a14-a2a9-6183d443158b.png)
...
![](assets/df4d9058-6795-4cb7-a86a-d2a4cc46aa79.png)
...
![](assets/21f51b34-043b-4238-8312-2a42582de788.png)
...
![](assets/9c11b1f1-7355-49a9-b593-74696be63e29.png)
...
![](assets/f7d41112-b38c-4121-b764-1979a72dd4e4.png)
...
![](assets/6d7e3937-f8a3-42e5-b908-fdead50ad71c.png)
...
![](assets/cb3a0724-e734-4782-a2dc-aa7ecfe5abda.png)
...
![](assets/4f1d33c8-b0db-47c7-aa13-07185fdef096.png)
...
![](assets/704067e3-6d6d-4dc0-89b4-a834109a4585.png)
...
![](assets/3a61d3c9-22b9-482c-a79f-95b35685736e.png)
...
![](assets/3a24c4e7-7463-4f9f-a215-c21bf165d098.png)
...
![](assets/c79cce09-3214-4f88-90af-bd1485460604.png)
...
![](assets/54ea0ef1-87a0-4c51-b761-14700f6c18b4.png)
