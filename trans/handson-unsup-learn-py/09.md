...
![](assets/4bd5bc8f-ede6-45e8-80ea-543706b24852.png)
...
![](assets/6776cf30-d26d-4c1b-aa66-65165ebac3a2.png)

但是这是一个**极小极大游戏**，也就是说两个对手 *A* 和 *B* 必须尽量最小化( *A* )和最大化( *B* )，目标一致。在这种情况下，生成器的目标是最小化先前双成本函数的第二项:

![](assets/1c69083f-4200-4599-a7af-1b594ab3bc20.png)
...
![](assets/304d8dd9-8212-4b27-a550-71c85664a763.png)

因此，通过解决以下问题可以达到最优:

![](assets/3ef1bf38-3d09-434a-993d-0a410667c1fe.png)
...
![](assets/bf275808-f597-4c3c-a017-6ecaa9f12a79.png)

全局目标可以通过使用最佳鉴别器来重写:

![](assets/fb61b945-753c-4d3a-ae24-b25d49b47952.png)

我们现在可以扩展前面的表达式:

![](assets/ecbc89dd-1468-4030-9b3b-f8afd8001855.png)

现在，让我们考虑两个分布 *a* 和 *b* 之间的库尔巴克-莱布勒散度:

![](assets/9e4f728c-21ba-4c78-951a-099df4986119.png)

考虑到前面的表达式，经过一些简单的操作，很容易证明以下等式:

![](assets/ea76a19a-d431-4d64-8ab4-2353158ec476.png)
...
![](assets/d5d8548e-abc4-4567-9a42-2def53203f69.png)
...
![](assets/a8df35ed-d5d1-4e6f-b381-f22b67ef545a.png)
...
![](assets/49bdaa5a-37a8-4fce-b39c-fa8b9ec22294.png)
...
![](assets/cb4a2f99-5422-4c6f-bc83-588e81037426.png)

因此，由于`loss_d_1`是真实样本的损失函数，我们使用运算符`tf.ones_like()`将所有标签设置为 1；因此，sigmoid 交叉熵的第二项变为零，结果如下:

![](assets/cc9c07fc-72da-4fae-b60c-9c17149f81cc.png)

相反，`loss_d_2`恰好需要乙状结肠交叉熵的第二项；因此，我们将所有标签设置为零，以获得损失函数:

![](assets/4bebedd1-9438-42e7-aae9-c18aa72d2a49.png)
...
![](assets/29d10031-02b1-448c-b339-0163f2d2bf5e.png)
...
![](assets/eeea0b30-618e-4267-9766-78baabc05fac.png)
...
![](assets/cf700f07-35ed-4e38-80db-a046bbe07d21.png)
...
![](assets/6409c4e2-844b-44d2-bd22-655dd88d2e4b.png)

该定理施加的主要约束是 *f(x)* 必须是一个 L-李普希茨函数，也就是说，给定一个非负常数， *L* ，以下公式适用:

![](assets/a97ddbd4-a379-4fc0-aad7-4de7a552abcd.png)

考虑使用神经网络参数化的函数*f()*，全局目标如下:

![](assets/ac4ed2f2-c377-4788-9950-1e7768520a25.png)
...
![](assets/c6e68853-8d2d-4ea5-9670-8fe1ad4803ac.png)
...
![](assets/aac13c86-1214-4c02-9078-f6b3fd5ecbf3.png)
...
![](assets/c547737d-8732-4c0e-bcb3-2b1ab893d875.png)
...
![](assets/0603623a-f55d-4792-a188-2b84df0f58c7.png)
...
![](assets/1d22e1e2-5d4d-472e-90eb-af603c0116eb.png)
...
![](assets/1cc30811-63e7-4ceb-a338-df23c28ca834.png)
...
![](assets/88ce6334-3cd3-41c5-a1de-9885b75dde3f.png)
