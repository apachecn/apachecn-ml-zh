...
![Getting started with the Google+ API](graphics/image_05_001.jpg)
...
![Getting started with the Google+ API](graphics/image_05_002.jpg)

图 5.2:为我们的项目启用谷歌+应用编程接口

API 启用后，系统会立即提醒我们，为了消费 API，我们需要某种凭证，如图*图 5.3* :

![Getting started with the Google+ API](graphics/image_05_003.jpg)
...
![Getting started with the Google+ API](graphics/image_05_004.jpg)
...
![Flask routes and templates](graphics/image_05_005.jpg)

图 5.5:Flask 应用程序的入口页面

如果我们点击**搜索！**按钮不插入任何输入，app 会再次显示带有错误信息的表单，如图*图 5.6* :

![Flask routes and templates](graphics/image_05_006.jpg)

图 5.6:如果没有给出查询，将显示错误消息

另一方面，如果正确给出查询，结果页面将显示为*图 5.7* (该图给出的查询为`packt`):

![Flask routes and templates](graphics/image_05_007.jpg)
...
![Text analysis and TF-IDF on notes](graphics/image_05_008.jpg)
