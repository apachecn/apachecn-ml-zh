...
![](assets/cd46ced0-2f96-410d-9801-0f7aa0f1fb90.png)
...
![](assets/69f79aee-22b1-481c-b230-2035e84f9d23.png)
...
![](assets/0eb77b3e-f4b9-483c-9426-4fa4498031ae.png)
...
![](assets/642c0bf0-c57c-491e-92e5-b0923f98f55f.png)
...
![](assets/82007989-4f27-47f2-bd42-69f1e2c7a49c.png)
...
![](assets/cfd2a688-480d-4f87-82e0-cd686e4bdf3c.png)

前面的图像是一个 5 x 5 像素的灰度图像，在白色背景下显示了一条黑色对角线。

从下图中提取特征，我们得到以下像素强度矩阵:

![](assets/f0fe030e-ccaa-4d16-9edb-32c7012b9689.png)

接下来，让我们假设我们(或 Keras)实例化了以下内核:

![](assets/d0f28169-8372-4341-954f-3867f5b576af.png)
...
![](assets/16616ed8-ac7b-4479-84a4-013bb46bb2c5.png)
...
![](assets/6a00c530-8e36-4547-9038-4cfadbd29e61.png)

3.  第三步:

![](assets/65e5b537-dd45-4afd-a1e5-6f1679b47ddb.png)

4.  我们已经到达图像的最右边。将窗口向下滑动 1，即我们的步幅大小，并在图像的最左边重新开始该过程:

![](assets/a19790b1-455f-4a34-96f0-aeb86d966c6a.png)

5.  第五步:

![](assets/1d16c2c3-909d-4a32-b221-8111f72cb5c9.png)

6.  第六步:

![](assets/bb8ce393-a48b-40c5-86cf-e7d5cac709a1.png)

7.  第七步:

![](assets/6c75d988-2688-4c58-a16e-ba6a3b23da98.png)

8.  第八步:

![](assets/b403905a-5501-4067-92ab-e41a221b564d.png)

9.  第九步:

![](assets/71dd0a5d-47a9-4e7d-804e-f1e833273591.png)

瞧啊。我们现在已经在一个 3×3 矩阵(我们的特征图)中表示了我们最初的 5×5 图像。在这个玩具示例中，我们已经能够将维度从 25 个特征减少到只有 9 个。让我们看一下这个操作产生的图像:

![](assets/9dac7706-ca00-4455-8cb1-6fa21d61e9f2.png)
...
![](assets/5550bd45-05ec-4fa9-9611-e5e383a9564c.png)
...
![](assets/8c08fee6-0ca0-4ec3-85ef-5a8894ca291d.png)

让我们看看当我们使用 2 x 2 窗口最大化前面的要素地图时会发生什么。同样，我们在这里所做的就是返回`max(values in window)`:

1.  返回`max(0,255,255,0)`，得到 us 255:

![](assets/6c75d908-819d-450b-ad34-eb16754aca77.png)

2.  第二步:

![](assets/cfa2a066-bab6-4b25-bc96-c98f85bda1e5.png)

3.  第三步:

![](assets/38d64d16-026a-4c48-9afd-413a09c42d45.png)

4.  第四步:

![](assets/32f83e69-0ce7-41c5-971b-06e015cd1e3a.png)
...
![](assets/43d89914-dd37-48cd-af87-1bc40ec8cce9.png)
...
![](assets/9325c607-8ce4-4e88-bdcf-e6355d65483f.png)
...
![](assets/e63af8b4-430b-47df-a61b-c6fc09bce587.png)
...
![](assets/a8500b89-ac19-4d4c-b8b6-8506b8303741.png)
...
![](assets/ec3a5302-7c97-4748-8bae-72a155ad21db.png)
...
![](assets/02c86512-feb3-4b76-bf86-1b412698621e.png)
...
![](assets/03c7a2b5-8520-4a03-9418-10238801bc15.png)

这些类是从 0 到 9 编码的。在自述文件中，Zalando 为我们提供了映射:

![](assets/e7cf2657-275b-4cfa-9f61-c0dc75214a1b.png)
...
![](assets/21924c3b-e0af-4a11-a139-27f612ad96c5.png)
...
![](assets/6bc6b269-edaa-4f0c-a68a-980ae4c01d42.png)
...
![](assets/0782a868-cbe5-4b34-a5ed-33ae7d0d6511.png)
...
![](assets/5fca7448-9f2a-4680-be20-ec3b55f749de.png)
...
![](assets/485b7f6f-0585-468a-b359-a5b0cd770863.png)
...
![](assets/b88953fb-ec6c-4b7a-bf4a-62caa3e1e736.png)
...
![](assets/d0a689ed-6b00-4d32-baf9-733f49b1804e.png)
...
![](assets/cfd56e4a-0ee6-4060-ad8b-04cc3521cc0b.png)
...
![](assets/7e6eb9cd-38e2-4a6b-a1f6-fd4b19c2adac.png)
...
![](assets/819a4e32-36b5-4fe9-91b8-2ceb69e1f8aa.png)
...
![](assets/ad4333d4-48bf-43f0-962c-725832e0a4d3.png)

这看起来更好！我们的培训和验证损失之间的差异已经缩小，这是预期的目的，尽管似乎确实有一些改进的空间。

接下来，重新绘制精度曲线。这是我的跑步记录:

![](assets/97fd4ea0-c7dc-412b-bd43-8da26dc2cf95.png)
...
![](assets/f8b9853f-45f0-440c-89fd-fa95f6b5b572.png)
