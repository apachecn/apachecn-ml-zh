...
![](assets/c726d9f1-a00b-4a60-a52c-0909e423500b.png)

我坚持说:

![](assets/1ee74215-5384-4f54-83c4-1c1df46de9ca.png)
...
![](assets/99d3a529-9e70-49f4-9478-89c70df123e8.png)
...
![](assets/230650be-ef8d-4ccb-b59f-00e15d4e6267.png)
...
![](assets/cd034e74-d600-432f-8611-380af2fee11e.png)
...
![](assets/0dce3fa1-0caf-44b3-bfec-863d7afe8cb6.png)

这些都不是由人类明确编码的，也没有按照要求出现在训练集中，然而，看着这些，就像和人类说话一样可怕。但让我们看看更多:

![](assets/591bc3ed-fb58-47f6-ac3e-77da623bd8ad.png)

请注意，模特的回应似乎是性别知识( **he** 、 **she** )、 **place** (英国)和职业(**选手**)。甚至意义、伦理和道德的问题都是公平的游戏:

![](assets/7d841798-609f-4249-8237-a9b8092442e4.png)

![](assets/7dc81f71-3e26-4ae0-8cd0-2f5652b4ad62.png)
...
![](assets/6d9fb676-13dc-4bb1-b64c-9a172256926b.png)
...
![](assets/a48abdb7-bcff-42f5-9d55-c7da9f2aed78.png)
...
![](assets/63ee8de3-1c46-4190-afb9-bad34daa3a40.png)
...
![](assets/b8069791-f4f5-4908-851f-585e4ef3b2d7.png)
...
![](assets/66fa20ef-b27f-44e2-8af5-bae861983084.png)
...
![](assets/e0f4a09b-d60c-4db2-a958-9e0b0ee6411a.png)
...
![](assets/6f020de1-b522-4912-ba1e-52f45a718d23.png)
...
![](assets/c9a792e9-1f44-42d2-946b-9b3736c2d8b0.png)
...
![](assets/9377dd8e-c551-4e69-8e32-709f149a06c1.png)
...
![](assets/beab46df-ae86-4fba-9292-b72e5ce81c0d.png)

```py
get_response('With beans on top?') 
```

![](assets/15082c21-bd1f-4d20-ad70-d46420b6a5db.png)

```py
get_response('What else do you like to do?') 
```

![](assets/265ec47e-43b4-4108-8508-f84206c682d4.png)

```py
get_response('What do you like about it?') 
```

![](assets/4b18b671-7d88-47a2-aee5-9ee79c643ede.png)

```py
get_response('Me, random?') 
```

![](assets/25bd083c-6922-4dd8-a00b-390058199df7.png)

```py
get_response('I think you mean you\'re') 
```

![](assets/f9571b10-2ff4-4cba-bb2b-d493ba9a961e.png)
...
![](assets/2b04592c-6902-4403-870e-4266daf360c7.png)
...
![](assets/3318e65a-0fc7-4a07-8620-8d81902c6079.png)
...
![](assets/0e4cad67-bd2e-41bf-a7d0-19bb870fe629.png)
...
![](assets/32be9bf4-34e1-4e41-bc29-af5e999cf409.png)
...
![](assets/a1f54278-2513-40d3-ae69-42a7a06014d5.png)
...
![](assets/34094ae5-2198-4796-afd4-066b044361a9.png)
...
![](assets/bc180728-de1a-4d09-bc5d-68c4f6a3e34b.png)
...
![](assets/ad208163-5986-4a4d-b6d4-95b800737727.png)
...
![](assets/57a91f41-a7da-468e-a92a-7589eb73593c.png)
...
![](assets/e99022f7-f9da-4cf0-8a12-fb58d03c72ff.png)

![](assets/6936b02e-4137-4c66-ad25-1e9291112554.png)

![](assets/7ed8edd3-c574-482d-9d93-d184a8e3f59e.png)

![](assets/4096f414-dfd7-46c7-a6e0-efb90b3712bd.png)

![](assets/78e8de23-1a8e-488e-b326-a2e01a4bbf44.png)

![](assets/c60b8d01-7f73-4862-b039-3ae1cbcea5c3.png)
